...
- `Brightness` - регулировка яркостью светодиодной индикации. От 0 до 255. При 0 - светодиоды остаются выключены. 255 - соответсвует максимальной яркости.
- `Frc co2 correction` - выводит значение поправки для `CO2`, если была выполнена принудительная калибровка.
